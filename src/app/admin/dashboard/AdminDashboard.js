...
export default function AdminDashboard({ initialEstimates }) {
  const [estimates] = useState((initialEstimates || []).sort((a, b) => new Date(b.createdAt) - new Date(a.createdAt)));
  ...
  const deleteCodeInjection = (id) => setCodeInjections(prev => prev.filter(ci => ci.id !== id));
  ...
  return (
    <div className="min-h-screen p-4 md:p-6 lg:p-8 container !my-10">
      ...
      {/* 🔹 Advanced Multiple Code Injections */}
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        ...
        <div className="p-4">
          ...
          <button 
            ...
            className="bg-[var(--accent-color)] text-white px-6 py-2 rounded-lg hover:bg-[var(--accent-color)] transition-colors mt-4"
          >
            Save All Settings
          </button>
        </div>
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-1">
                ...
                >
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5l-7 7 7 7"></path></svg>
                </button>
