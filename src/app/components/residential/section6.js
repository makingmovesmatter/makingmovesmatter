  ...
  return (
    <div className="w-full py-16 section-area-serve">
      <div className="container mx-auto">
        <h2 className="text-4xl pt-6 font-bold text-[var(--black-color)] capitalize py-2">
          Areas We Serve
        </h2>
        <p className="text-[var(--black-color)] text-md pb-4">
        ...
        <div className="grid grid-cols-1  md:grid-cols-2 gap-5 p-5">
          {features.map((pro, index) => (
            ...
            >
              ...
              <h3 className="text-3xl font-bold text-[var(--black-color)] capitalize py-2">
                {pro.title}
              </h3>
            </div>
          ))}
