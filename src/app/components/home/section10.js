    ...
    <div className="w-full py-10 px-6 bg-white relative">
      <div className="container mx-auto">
        ...
        <p className="text-[var(--heading-text-color)] text-md pb-8 max-w-2xl">
          ...
          Whether you’re gearing up for a full relocation or just prepping ahead
          of time, you’ll find helpful resources to make the process smoother.
        </p>
      </div>

      {/* Custom Arrows */}
      <div className="absolute left-0 top-[calc(50%+50px)] z-10">
        <button
      ...
      <div className="absolute right-0 top-[calc(50%+50px)] z-10">
        <button
